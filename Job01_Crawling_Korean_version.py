...
language_btn_xpath = '/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[7]/div/div/div/section/section/div[1]/div/div[1]/div/div/div[2]/div/div/div[2]/div/div/div/button'
korean_btn_xpath = '/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[7]/div/div/div/section/section/div[1]/div/div[1]/div/div/div[2]/div/div/div[2]/div/div/div/div/ul/li[{}]/span'
korean_check_xpath = '/html/body/div[1]/main/div[1]/div[2]/div[2]/div[2]/div/div[1]/section[7]/div/div/div/section/section/div[1]/div/div[1]/div/div/div[2]/div/div/div[2]/div/div/div/div/ul/li[{}]/span/div/span'
...
# catecory=5     # 콘서트&쇼핑(2,5)
my_catecory = [2,5]
for catecory in my_catecory:
    for i in range(0,4):      # 4페이지까지 120개
        print('[ page', i+1,']')
        for j in range(2,40):       # 1페이지 - 1~30개 크롤링 / 즐길거리 목록. 1페이지에 30개, xpath: 2~39까지 (중간에 5,9,13,17,22,27,32,37이 없음)
            ...
            try:
                ...
                try:
                    ...
                    print('link_selector error', j, url)
                    continue
            ...
            for page in range(20):  # 20페이지까지 총 200개
                ...
                time.sleep(0.5)
                ## 리뷰 한글화
                driver.find_element(By.XPATH, language_btn_xpath).click()
                for i in range(20):
                    try:
                        if driver.find_element(By.XPATH, korean_check_xpath.format(i)).text == '한국어':
                            driver.find_element(By.XPATH, korean_btn_xpath.format(i)).click()
                            # print("check")
                    except:
                        continue
                time.sleep(0.5)
